...
void DisplayManager::showMenu(int selected, float battVoltage, int battPercent, bool charging) {
    display.clearDisplay();
    display.setTextSize(1);
    display.setCursor(0, 0);
    ...
    display.println("--------------------");
    display.println(selected == 0 ? "> Medir 1 punto" : "  Medir 1 punto");
    display.println(selected == 1 ? "> Medir varios"  : "  Medir varios");
    display.println(selected == 2 ? "> Subir CSV"     : "  Subir CSV");
    display.println();
    display.println("Corto: bajar");
    display.println("Largo: elegir");
    display.display();
}

void DisplayManager::showMultiMenu(int selected, float battVoltage, int battPercent, bool charging) {
    display.clearDisplay();
    display.setTextSize(1);
    display.setCursor(0, 0);
    ...
    display.println("--------------------");
    display.println(selected == 0 ? "> 30 segundos" : "  30 segundos");
    display.println(selected == 1 ? "> 1 minuto"    : "  1 minuto");
    display.println(selected == 2 ? "> 5 minutos"   : "  5 minutos");
    display.println(selected == 3 ? "> 10 minutos"  : "  10 minutos");
    display.println(selected == 4 ? "> 20 minutos"  : "  20 minutos");
    display.println(selected == 5 ? "> Volver"      : "  Volver");
    display.display();
}
